...
# For the arrival time of each process,
#  use the Normal distribution with the given mean 
# and standard deviation to generate a random value.

# For the burst time of each process, 
# use the Normal distribution with the given mean 
# and standard deviation to generate a random value.

# For the priority of each process, 
# use the Poisson distribution with the given λ to generate a random value.
